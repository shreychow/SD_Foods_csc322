...
//     setCustomer(user);
//     fetchFeedbackHistory(user.user_id || user.customer_id || user.id);
//   }, [navigate]);
...
//         customer_id: customer.user_id || customer.customer_id || customer.id,
//         type: feedbackType,
...
//       setTargetId("");
//       setOrderId("");
//       fetchFeedbackHistory(customer.user_id || customer.customer_id || customer.id);
//     } catch (err) {
...
//                     The system will automatically find the {targetType} for this order.
//                   </p>
//                 </div>
//               )}
...
//                       <span className="badge">{fb.type?.toUpperCase() || "FEEDBACK"}</span>
...
//                     </p>
//                     {fb.order_id && (
//                       <p className="text-small text-muted" style={{ margin: "0 0 8px 0" }}>
//                         Order #{fb.order_id}
//                       </p>
//                     )}
...
//                     <p style={{ margin: "0 0 8px 0" }}>{fb.message}</p>
//                     {fb.type === "complaint" && 
//                      (fb.status === "open" || fb.status === "pending" || fb.status === "under review") && (
